...
def test_trickle_repair(network, node_to_fail):
    ...
    """
    sim_duration = 50
    network.start_simulation_trickle_repair(sim_duration, node_to_fail)
...
if __name__ == "__main__":
    ...
    """
    network = test_auto_configure_network(n_nodes, radius, area_size, 3)
